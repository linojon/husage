...
module ApplicationHelper
  ...
  def form_help( topic )
    "<img src=\"images/icon_help.gif\" onclick=\"alert('#{topic.to_s.humanize}: #{HELP_TOPICS[topic]}.')\" />"
  end
  ...
  HELP_TOPICS = {
    ...
    :run_hourly => 'If checked, your usage report will be re-calculated once an hour. When not checked, reports will be automatically be calculated and alerts will not be sent out',
